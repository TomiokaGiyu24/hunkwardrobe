  ...
  return (
    <div className="page-wrapper" style={{ paddingTop: 68 }}>
      ...
      >
        ...
        >
          ...
          <div style={{ borderTop: '1px solid var(--border)', paddingTop: 24, marginBottom: 12 }}>
            ...
            <button onClick={handleOrderClick} className="btn-whatsapp" style={{ width: '100%', justifyContent: 'center', marginBottom: 12 }}>
      ...
      <OrderFormModal
        ...
        productName={`${activeJersey.player || activeJersey.lastName} - ${activeJersey.category === 'jersey' ? activeJersey.edition : activeJersey.category} (Size: ${selectedSize})`}
      />
